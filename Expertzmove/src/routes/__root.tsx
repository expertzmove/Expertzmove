  ...
  head: () => ({
    meta: [
      ...
      { title: "Expertz Move — Trading, on autopilot" },
      {
        name: "description",
        content:
          "Expertz Move is a small team building an AI trading toolkit that handles the screens so you don't have to. Daily top-gainer updates, live charts, and bots that actually behave.",
      },
      { name: "author", content: "Expertz Move" },
